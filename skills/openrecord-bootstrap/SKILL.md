...
Write records as you go, but **each one is confirmed by the user before it is written** — not in a
batch at the end, and not silently because they answered the question.
